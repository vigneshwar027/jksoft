            ...
            try:
                ...
                if(notetype=="Receipt"):
                    ...
                    if("1765" in catype.group(1).split(' - ')[0].strip()):
                        ...
                        file_rename=name1.strip()+" -I765 "+creq3+" Receipt Notice "+rdate3.strip()+".pdf"
                        ...
                        print(ndate3)
                        print(bname1)                        
                        file_rename=bname1.strip()+" - "+name1.strip()+" - "+creq2+" Receipt Notice - "+ndate3+".pdf" #done
                        ...
                        #print(rdate2)
                        #print(rdate0)                    
                        file_rename=name1.strip()+" - I485 Receipt Notice - "+rdate3+".pdf"
                        #done n date needed
                        ...
                        # print(rdate)
                        # quit()            
                        file_rename= "I539 Receipt Notice - "+name2.strip()+" - "+ndate3.strip()+".pdf" 
                        #done rena
                        #print(file_rename)                    
                    else:
                       
                        file_rename=manual_replace(name1.strip()+catype.group(1).split(' - ')[0].strip(),'I-',0)+" - "+notetype+" - Notice - "+rdate3.strip()+".pdf"      
                    ...
                    ndate_y = re.search('NOTICE DATE(.*)', text).group(2)           
                    ...
                    # print('xxx: ',catype[0].strip())
                    # quit()
                    
                    if("1-131" in catype[0].strip() or "L-131" in catype[0].strip().split(".")[0] or "I-131" in catype[0].strip().split(".")[0]):
