        ...
        for file in onlyfiles:
            ...
            if(nottype==None):
                ...
                if(nottype==None):
                    ...
                    if(nottype==None):
                        nottype = re.search('Application for(.*?) Now that',text)
                        if(nottype==None):
                            nottype = re.search('U.S. Citizenship and Immigration Services(.*?) REQUEST FOR EVIDENCE',text)
                ...
                # nottype7 = re.search('Application for(.*?) Now that',text)



            
            try:
                if(nottype.group(1).split(' Notice')[0]!=None):
                ...
                if 'DECISION' in notetype:
                    
                    
                    Notice_type = 'Denial Notice'

                    catype = re.search('U.S. Citizenship and Immigration Services(.*?) DECISION',text).group() 

                    catype = catype.split(',')[-2].split(' ')[-1]
                    ...
                    b_name = re.search('RE:(.*)Application for', text).group().split(',')[0].split(':')[1]

                    b_name = b_name.split(' ')[:-1]
                    b_name = " ".join(b_name).strip()

                    # print(b_name)
                   
                    file_rename = b_name+" - "+catype+" - Denial Notice"+".pdf"    
                ...
                if 'REQUEST FOR EVIDENCE' in nottype.group():
                    
                  
                    if 'PREMIUM PROCESSING' in text:
                        Notice_type = 'RFE PP Notice'
                    else:
                        Notice_type = 'RFE Notice'
                           
                    catype = re.search('U.S. Citizenship and Immigration Services(.*?) REQUEST FOR EVIDENCE',text).group() 
                    ...
                    if not 'I-129' and '1 129' and '1-129' and 'I-129,' in nottype.group():

                        print(nottype.group())
                        b_name = re.search('RE:(.*)REQUEST FOR EVIDENCE', text).group().split(',')[0].split(':')[1]

                        b_name = b_name.split(' ')[:-1]
                        b_name = " ".join(b_name).strip() 

                        file_rename = b_name+" - "+catype+" - "+Notice_type+" "+".pdf"    

                    else:          
                        file_rename = catype+" - "+Notice_type+" "+".pdf"    
                ...
                if(notetype=="Receipt"):
                    ...
                    if(ndate==None):
                        ...
                        if(ndate==None):
                            ndate=re.search('Notice Date(.*)Case Type', text)
                    ...
                    if("1765" in catype.group(1).split(' - ')[0].strip()):
                        ...
                        rdate1=rdate2[1]
                        rdate0=rdate2[0][-2:]
                        file_rename=name1.strip()+" - I765 Receipt Notice - "+rdate3.strip()+".pdf"
                        #print(file_rename)
                        ...
                        #print(ndate3)
                        #print(bname1)                        
                        file_rename=bname1.strip()+" - "+name1.strip()+" - "+creq2+" Receipt Notice - "+ndate3+".pdf" 
                        #print(file_rename)
                        ...
                        #print(rdate2)
                        #print(rdate0)                    
                        file_rename=name1.strip()+" - I485 Receipt Notice - "+ndate1[2]+".pdf"
                        #print(file_rename)
                        ...
                        #print(rdate)
                        #print(name2)                    
                        file_rename="I539 Receipt Notice- "+ndate3.strip()+"-"+name2.strip()+".pdf" 
                        #print(file_rename) 
                        ...
                        file_rename=name1.strip()+" - "+catype.group(1)+" Receipt Notice - "+ndate1[2].strip()+".pdf"      
                        file_rename=file_rename.replace("Receiver","").replace("I485)","I485J")
                    file_rename = fnameclean(file_rename)
                    os.rename(mypath+'/'+file,mypath+'/'+file_rename)
                    sheet.append((file,file_rename,'File was renamed',today,'Data not updated','','Notice type not configured'))
                    dest = get_next_file(file_rename, mypathd)
                    ...
                    ndate1=ndate.group(1).split("/")
                    ndate1[2]=ndate1[2][:4]
                    if("1-131" in catype[0].strip() or "L-131" in catype[0].strip().split(".")[0] or "I-131" in catype[0].strip()):
                        ...
                        file_rename=name.replace(".","")+"I131 Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                        ...
                        file_rename=name.strip()+" - I485 Receipt Notice - "+rdate1[6].strip()+".pdf"
                        ...
                        try:
                            ...
                            file_rename="I-130 - "+"Receipt"+" - "+rdate1[2].strip()+"-"+str(rdatemon)+"-"+rdate1[1].strip().replace(",","")+" - "++".pdf"
                        except:                        
                        ...
                        try:
                            rdatemon=mon_conversion(rdate1[1].strip())
                            file_rename=result.group(1).strip()+" - I539 Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                        except:                        
                            file_rename=result.group(1).strip()+" - I539 Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                            pass 
                        file_rename = fnameclean(file_rename)                        
                        ...
                        try:
                            ...
                            file_rename=rname.strip()+" - "+result.group(1).strip()+" - I140 Receipt Notice - "+rdate1[6].strip()+".pdf"
                        except:                        
                            file_rename=rname.strip()+" - "+result.group(1).strip()+" - I140 Receipt Notice - "+rdate1[6].strip()+".pdf"
                            pass
                        file_rename = fnameclean(file_rename)                       
                        ...
                        try:
                            ...
                            file_rename=name+" - "+catype[0].strip()+" "+creq.group(1)+"Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                            #print(file_rename)
                        except:                        
                            file_rename=name+" - "+catype[0].strip()+" "+creq.group(1)+"Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                            pass                    
                    ...
                    if("1765" in catype.group(1)):
                        ...
                        rdate= re.search('Nolice Date (.*) Page 1', text)
                        if(rdate==None):
                            rdate= re.search('Notice Date (.*) Page 1', text) 
                            if(rdate==None):
                                rdate= re.search('Notice Dale (.*) 1 of', text)
                        match = re.sub(r'\w*\d\w*', '', result.group(1))
                        name1=rem_duplicate(match.strip())
                        ...
                        file_rename=name1.strip().replace("Received Date","")+" - I485J Approval Notice - "+ndate1[2]+".pdf"
                        #print(file_rename)                        
                    else:
                        result = re.search('Applicant(.*)Beneficiary', text)
                        ...
                        if("1485" in catype.group(1)):           
                            file_rename=name1.strip()+" - I485 Approval Notice - "+ndate1[2]+".pdf" 
                        else:
                    ...
                    ndate1=ndate.group(1).split("/")
                    ndate1[2]=ndate1[2][:4]
                    file_rename=name1.strip()+" - "+catype.group(1).split(' - ')[0].strip()+" Transfer Notice"+" - "+ndate1[2]+".pdf" 
                    #print(file_rename) 
                    ...
                    if("1140" in catype.group(1)):
                        ...
                        file_rename=name1[1].strip()+" - "+name1[0].strip()+catype.group(1)+" PP Receipt Notice - "+ndate3.strip()+".pdf"
                    else:
            ...
            try:
                ...
                if(notetype=="Approval"):
                    ...
                    if('1539' in text or 'i539' in text or 'I-539' in text  or '1-539' in text):
                        ...
                        file_rename=creq3+" Approval Notice - "+ndate3+" - "+name1.strip()+".pdf"
                        ...
                        if('1765' in text or 'i765' in text or 'I-765' in text  or '1-765' in text):
                            file_rename=name2.strip()+"I765 "+creq2+" Approval Notice"+" - "+ndate3+".pdf" 
            ...
            try:
                ...
                if(notetype1.strip()=="ASC Appointment Notice" or notetype1.strip()=="Biometric Notification"):
                    ...
                    rdate1=rdate2[1]
                    rdate0=rdate2[0][-2:]
                    ndate = re.search('PERMANENT RESIDENCE OR (.*) ADJUST STATUS', text)
                    ...
                    if(catype1.strip()!="N400"):
                        if('1539' in catype1):
                            file_rename=name1.strip()+"I539 ASC Appointment Notice - "+ndate1[2]+".pdf"
                        else:
                            file_rename=name1.strip()+" - "+catype2.strip()+" ASC Appointment Notice "+ndate1[2]+".pdf"
                    else:
                        file_rename=name1.strip()+" - "+catype.strip()+" ASC Appointment Notice "+ndate1[2]+".pdf"                
                    #print(file_rename)
                    file_rename = fnameclean(file_rename)
                    os.rename(mypath+'/'+file,mypath+'/'+file_rename)
                    sheet.append((file,file_rename,'File was renamed',today,'Data not updated','','Notice type not configured'))
            ...
            try:
                ...
                if(notetype3.strip()=="Recei t CASE" or notetype3.strip()=="Reit CASE" or notetype3==" it CASE" or notetype3==" Receipt CASE"):
                    ...
                    if(catype.group(1).strip().split(" ")[0]=="1-539"):
                        ...
                        try:
                            rdatemon=mon_conversion(rdate1[0].strip())
                            file_rename=result.group(1).strip()+" - "+"I539 Receipt Notice"+" - "+rdate1[2].strip()+"-"+str(rdatemon)+"-"+rdate1[1].strip()+" - "+".pdf"
                        except:                        
                            file_rename=result.group(1).strip()+" - "+"I539 Receipt Notice"+" - "+rdate.group(1).strip()+" - "+".pdf"
                            pass                    
                        ...
                        try:
                            rdatemon=mon_conversion(rdate1[0].strip())
                            file_rename=result.group(1).strip()+" - "+"I130 Receipt Notice"+" - "+rdate1[2].strip()+"-"+str(rdatemon)+"-"+rdate1[1].strip()+".pdf"
                        except:                        
                            file_rename=result.group(1).strip()+"I130 Receipt Notice"+" - "+rdate.group(1).strip()+".pdf"
                            pass
                    else:
                        rdate = re.search('RECEIVED DATE(.*) PAGE 1', text)
                        ...
                        if("I-131" in catype.group(1)):
                            file_rename=name+"I-131 Receipt Notice - "+rdate1[6].strip()+".pdf"
                        else:    
                            try:
                                rdatemon=mon_conversion(rdate1[1].strip())
                                file_rename=name+catype.group(1)+"Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                            except:                        
                                file_rename=name+catype.group(1)+"Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                                pass                    
            ...
            try:
                ...
                if('Receipt' in notetype6.strip()): 
                    ...
                    name1=name1.replace("$","")
                    #print(name1)
                    ndate = re.search('NOTICE DATE (.*) USCIS ALIEN', text)
                    ndate1=ndate.group(1).split(" ")
                    ndate3=ndate1[2][:4]
                    ...
                    if(catype.group(1).split(' ')[0].strip()!="N-400"):
                        ...
                        if(len(rdate1)>3):
                            if("I-131" in catype1):
                                file_rename=name1.strip()+" - I131 Receipt Notice"+" - "+rdate1[6].strip()+".pdf"
                            else:
                                file_rename=name1.strip()+" - "+catype1+" Receipt Notice"+" - "+ndate3+".pdf"
                        else:
                            file_rename=name1.strip()+" - "+catype1+" Receipt Notice"+" - "+ndate3+".pdf"
                    else:
                        #print("loop2")
                        file_rename=name1+" - "+catype.group(1)+" Receipt Notice"+" - "+ndate3+".pdf"
...
def fnameclean(file_name):
    ...
    file_name=file_name.replace("TCR","")
