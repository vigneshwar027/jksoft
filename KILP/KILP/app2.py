    ...
    for index, row in df.iterrows():
        ...
        if True:
            ...
            if beneficiary_xref:
                ...
                length = len(results)
                if length <= 0:
                    cursor.execute("INSERT INTO dbo.Beneficiary(PetitionerId, BeneficiaryXref, BeneficiaryType, SourceCreatedDate, IsActive, InactiveDate, LastName, FirstName, PrimaryBeneficiaryXref, PrimaryBeneficiaryLastName, PrimaryBeneficiaryFirstName, RelationType, ImmigrationStatus, ImmigrationStatusExpirationDate, MostRecentI797IssueApprovalDate, MostRecentI797Status, I797ExpirationDate, FinalNivDate, MaxOutDateNote, from_name, is_primary_beneficiary,Beneficiary_Xref2, FullName, PrimaryBeneficiaryFullName, Current_Immigration_Status,CurrentImmigrationStatusExpirationDate2  ) VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')".format(petitioner_id, beneficiary_xref, beneficiary_type, beneficiary_record_creation_date, beneficiary_record_status, beneficiary_record_inactivation_date, beneficiary_last_name, beneficiary_first_name, primary_beneficiary_id, primary_beneficiary_last_name, primary_beneficiary_first_name, relation, immigration_status, immigration_status_expiration_status, i797_approved_date, i797_status, i797_expiration_date, final_niv_maxout_date, maxout_note, from_name, is_primary_beneficiary,beneficiary_xref2, beneficiary_full_name, primary_beneficiary_full_name, Current_Immigration_Status, current_status_expiration))
                    cursor.execute("SELECT @@IDENTITY AS ID;")
                    beneficiary_id = cursor.fetchone()[0]
                    cursor.commit()
                else:
                    beneficiary_id = results[0].BeneficiaryId
                    cursor.execute("UPDATE  dbo.Beneficiary SET PetitionerId='{}', BeneficiaryXref='{}', BeneficiaryType='{}', SourceCreatedDate='{}', IsActive='{}', InactiveDate='{}', LastName='{}', FirstName='{}', PrimaryBeneficiaryXref='{}', PrimaryBeneficiaryLastName='{}', PrimaryBeneficiaryFirstName='{}', RelationType='{}', ImmigrationStatus='{}', ImmigrationStatusExpirationDate='{}', MostRecentI797IssueApprovalDate='{}', MostRecentI797Status='{}', I797ExpirationDate='{}', FinalNivDate='{}', MaxOutDateNote='{}', from_name='{}', is_primary_beneficiary='{}',Beneficiary_Xref2='{}',FullName='{}',PrimaryBeneficiaryFullName='{}', Current_Immigration_Status='{}', CurrentImmigrationStatusExpirationDate2='{}'   WHERE BeneficiaryId='{}'  ".format(petitioner_id, beneficiary_xref, beneficiary_type, beneficiary_record_creation_date, beneficiary_record_status, beneficiary_record_inactivation_date, beneficiary_last_name, beneficiary_first_name, primary_beneficiary_id, primary_beneficiary_last_name, primary_beneficiary_first_name, relation, immigration_status, immigration_status_expiration_status, i797_approved_date, i797_status, i797_expiration_date, final_niv_maxout_date, maxout_note, from_name, is_primary_beneficiary, beneficiary_xref2, beneficiary_full_name, primary_beneficiary_full_name, Current_Immigration_Status, current_status_expiration, beneficiary_id))
                    cursor.commit()
...
def ActiveEmployeeReport(result_filepath):
    ...
    ws_r = wb_r.add_worksheet("Active Employee Report")
    ...
    headers_table = ['FullName', 'EmployeeId', 'Department','Business_Unit_Code', 'Department_Group', 'EmploymentStartDate', 'BirthCountry', 'CitizenshipCountry', 'petitioningjobtitle','petitioningjoblocation', 'ImmigrationStatus', 'ImmigrationStatusExpirationDate', 'I797ExpirationDate', 'I94ExpirationDate', 'EadExpirationDate','AdvanceParoleExpirationDate', 'ManagerName', 'SecondLevelManager', 'FinalNivDate', 'priority_date']
    ...
    results_active = cursor.execute("SELECT b.*,\
        ...
        c.petitioningjobtitle, c.petitioningjoblocation, '' as priority_date \
        FROM dbo.[Case] as c  \
        ...
        where b.IsActive = '1' \
        ORDER BY b.FullName ASC").fetchall()
        
    count = len(results_active)
    if count == 0:
        count = count + 1
    ws_r.add_table('A1:T'+str(count+1),{'columns': header_names, 'style': 'Table Style Medium 2'})
